...
<template:include view="hidden.generic">
    <template:param name="connectorServiceName" value="SalesforceApi"/>
    <template:param name="title" value="soauthnt_salesforceOAuthView"/>
    <template:param name="properties">
        <json:array>
            ...
            <json:object>
                <json:property name="name" value="sandbox"/>
                <json:property name="mandatory" value="${false}"/>
            </json:object>
        </json:array>
    </template:param>
