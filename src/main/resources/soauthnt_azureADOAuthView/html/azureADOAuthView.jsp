...
<template:include view="hidden.generic">
    <template:param name="connectorServiceName" value="AzureADApi20"/>
    <template:param name="title" value="soauthnt_azureADOAuthView"/>
    <template:param name="properties">
        <json:array>
            ...
            <json:object>
                <json:property name="name" value="tenantID"/>
                <json:property name="mandatory" value="${false}"/>
            </json:object>
            <json:object>
