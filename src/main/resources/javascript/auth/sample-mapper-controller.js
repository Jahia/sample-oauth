(function () {
    ...
    angular.module('JahiaOAuthApp').controller('SampleMapperController', SampleMapperController);
    SampleMapperController.$inject = ['$routeParams', 'settingsService', 'helperService', 'i18nService'];

    function SampleMapperController($routeParams, settingsService, helperService, i18nService) {
        ...
        vm.saveMapperSettings = () => {
            ...
            settingsService.setMapperMapping({
                ...
                helperService.errorToast(`${data.error}`);
            });
        };
        ...
        vm.getMapperI18n = value => i18nService.message('KeycloakApi20.label.' + value.replace(':', '_'));
