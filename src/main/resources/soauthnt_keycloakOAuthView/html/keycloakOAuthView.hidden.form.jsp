...
<div layout="row">
    <md-input-container flex>
        ...
        <input type="text" ng-model="${connectorVar}.realm" name="realm" required/>
...
<div layout="row">
    <md-input-container class="md-block" flex>
        ...
        <input type="url" ng-model="${connectorVar}.baseUrl" name="baseUrl" required/>
        <div ng-messages="${connectorFormVar}.baseUrl.$error" ng-show="${connectorFormVar}.baseUrl.$invalid"
             role="alert">
