...
<template:include view="hidden.generic">
    <template:param name="connectorServiceName" value="KeycloakApi20"/>
    <template:param name="title" value="soauthnt_keycloakOAuthView"/>
    <template:param name="properties">
        <json:array>
            ...
            <json:object>
                ...
                <json:property name="mandatory" value="${true}"/>
                <json:property name="defaultValue" value="KeycloakApi20"/>
            </json:object>
            <json:object>
            ...
            <json:object>
                <json:property name="name" value="baseUrl"/>
                <json:property name="mandatory" value="${true}"/>
            </json:object>
            <json:object>
