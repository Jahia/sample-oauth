    ...
    public ActionResult doExecute(HttpServletRequest httpServletRequest, RenderContext renderContext, Resource resource, JCRSessionWrapper jcrSessionWrapper, Map<String, List<String>> parameters, URLResolver urlResolver) throws Exception {
        ...
        String authorizationUrl = JCRTemplate.getInstance().doExecuteWithSystemSession(new JCRCallback<String>() {
            ...
            public String doInJCR(JCRSessionWrapper session) throws RepositoryException {
                ...
                JCRNodeWrapper jcrNodeWrapper = jahiaOAuthNode.getNode(KeycloakConnectorImpl.KEY);
                keycloakConnectorImpl.updateBaseUrlAndRealm(jcrNodeWrapper.getPropertyAsString(KeycloakConnectorImpl.BASEURL), jcrNodeWrapper.getPropertyAsString(KeycloakConnectorImpl.REALM));
                return jahiaOAuthService.getAuthorizationUrl(jahiaOAuthNode, keycloakConnectorImpl.getServiceName(), sessionId, new HashMap<String, String>());
            }
        });
